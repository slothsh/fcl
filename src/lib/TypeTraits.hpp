...
template<size_t I, typename Kind, typename Variant, typename Inner, InvocableConstReferenceReturn<std::remove_cvref_t<Inner>&> auto F, Kind... Kinds>
